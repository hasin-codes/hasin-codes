...
Developing [ZFushou](https://zfushou.hasinraiyan.me/)

### AI • Systems • Applied Machine Learning

I’m a developer focused on building systems where AI models, data pipelines, and product execution connect into working software.

I work across **AI engineering**, **product design**, and **development**, with a focus on multimodal architectures and learning-based systems.
...
- Working with multimodal AI architectures inspired by **encoder–decoder foundation models (AION-style systems)**
- Exploring **diffusion-based sequence modeling** as an alternative to autoregressive generation
...
> Building systems that connect models, data, and real-world execution into usable software.
